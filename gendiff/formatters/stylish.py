...
#             lines.append(
#                 f"{indent}{key}: {stringify_value(val, depth + 1)}"
#             )
...
#     indent = ' ' * (depth * SPACES)
#     sign_indent = ' ' * (depth * SPACES - 2)

#     if node.status == 'unchanged':
#         return (
#             f"{sign_indent}  {node.key}: "
#             f"{stringify_value(node.value, depth)}"
#         )
...
#         return (
#             f"{sign_indent}- {node.key}: "
#             f"{stringify_value(node.old_value, depth)}\n"
#             f"{sign_indent}+ {node.key}: "
#             f"{stringify_value(node.new_value, depth)}"
#         )

#     if node.status == 'nested':
#         return (
#             f"{indent}{node.key}: "
#             f"{format_tree(node.children, depth)}"
#         )
...
#         lines.append(format_node(node, depth + 1))
